...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="NONE" LPM_CVALUE=00000050 LPM_WIDTH=32 result
...
module  floor_height_lpm_constant_q1b
	( 
	result) ;
	output   [31:0]  result;
	...
	defparam
		mgl_prim1.cvalue = 32'b00000000000000000000000001010000,
...
endmodule //floor_height_lpm_constant_q1b
//VALID FILE
...
module floor_height (
	...
	floor_height_lpm_constant_q1b	floor_height_lpm_constant_q1b_component (
				.result (sub_wire0));
